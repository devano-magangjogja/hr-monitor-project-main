...
class PresensiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // List pemagang untuk dropdown modal — hanya yang BELUM tercatat presensinya pada tanggal ini
        $pemagangs = Pemagang::whereDoesntHave('presensis', function ($q) use ($tanggal) {
            $q->where('tanggal', $tanggal);
    ...
    public function laporan(Request $request)
    {
        ...
        $rekapPemagang = $pemagangs->through(function ($p) use ($kantorFilter) {
            ...
            // ── Metrik utama dihitung dari SEMUA session (entry + break_return)
            // Sehingga keterlambatan di Presensi Istirahat juga ikut menambah poin "Telat"
            ...
            // ── Breakdown khusus untuk modal "Lihat Detail Presensi"
        ...
        return view('admin.presensi.laporan-presensi', compact(
            'rekapPemagang',
            'stats',
            'logs',
            'divisiList',
