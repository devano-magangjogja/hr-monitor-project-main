...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ob.tasks.index', compact('tasks'));
    }
    ...
    public function dailyIndex()
    {
        ...
        $tasks = $this->taskService->sortTasksByStatus($tasks, Auth::id());
        return view('ob.tasks.daily', compact('tasks'));
    }
    ...
    public function assignedIndex()
    {
        ...
        $tasks = $this->taskService->sortTasksByStatus($tasks, Auth::id());
        return view('ob.tasks.assigned', compact('tasks'));
    }
    ...
    public function allIndex()
    {
        ...
        $tasks = $this->taskService->sortTasksByStatus($tasks, Auth::id());
        return view('ob.tasks.all', compact('tasks'));
    }
    ...
    public function history(Request $request)
    {
        ...
        return view('ob.history.index', compact('tasks', 'date', 'search'));
    }
}
