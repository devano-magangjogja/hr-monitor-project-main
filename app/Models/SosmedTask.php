...
class SosmedTask extends Model
{
    ...
    public function isDoneByStaff(): bool
    {
        return $this->status === 'done_by_staff';
    }

    public function isVerifiedByPm(): bool
    {
        return $this->status === 'verified_by_pm';
    }

    public function isApprovedHr(): bool
    {
        return $this->status === 'approved_hr';
    }
    ...
    public function getStatusLabelAttribute(): string
    {
        return match ($this->status) {
            ...
            'verified_by_pm' => 'Menunggu Approval HR Staff',
            'approved_hr'    => 'Disetujui Final (Selesai)',
