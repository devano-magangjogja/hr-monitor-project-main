...
@section('title', 'Pantau OB (Office Boy)')
@section('page-title', 'Pantau OB (Office Boy)')
@section('page-subtitle', 'Pantau seluruh tugas yang masuk ke OB (Office Boy) hari ini')
        ...
        @empty
            <tr>
                <td colspan="6" class="px-3 py-12 text-center text-gray-400 text-sm">
                    Tidak ada tugas dari OB (Office Boy) hari ini.
                </td>
            </tr>
        @endforelse
        </tbody>
