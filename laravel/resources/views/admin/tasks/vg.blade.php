...
@section('title', 'Pantau VG (Videografer)')
@section('page-title', 'Pantau VG (Videografer)')
@section('page-subtitle', 'Pantau seluruh tugas yang masuk ke VG (Videografer) hari ini')
        ...
        @empty
            <tr>
                <td colspan="6" class="px-3 py-12 text-center text-gray-400 text-sm">
                    Tidak ada tugas dari VG (Videografer) hari ini.
                </td>
            </tr>
        @endforelse
        </tbody>
