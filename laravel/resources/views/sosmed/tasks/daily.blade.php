        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left border-collapse min-w-[700px]">
                ...
                <tbody class="divide-y divide-gray-100 bg-white">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-400 text-sm">Tidak ada tugas harian hari ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
<script>
    function openCompleteModal(id, title) {
        ...
        document.getElementById('form-complete').action = `/sosmed/tasks/daily/${id}/complete`;
