...
@section('content')
        ...
        <table class="w-full text-sm table-fixed">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-200">
                    <th class="text-left px-6 py-3.5 font-semibold text-gray-600 w-[22%]">Judul</th>
                    <th class="text-left px-6 py-3.5 font-semibold text-gray-600 w-[30%]">Deskripsi</th>
                    <th class="text-left px-6 py-3.5 font-semibold text-gray-600 w-[16%]">Target Role</th>
                    <th class="text-left px-6 py-3.5 font-semibold text-gray-600 w-[12%]">Status</th>
                    <th class="text-left px-6 py-3.5 font-semibold text-gray-600 w-[14%]">Dibuat Oleh</th>
                ...
                @forelse($defaultTasks as $task)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span class="inline-flex items-center truncate max-w-full px-2.5 py-1 rounded-full text-xs font-semibold {{ $targetRoleModel?->badge_class ?? 'bg-gray-100 text-gray-700' }}">
        ...
        @forelse($defaultTasks as $task)
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                ...
                <div class="flex flex-wrap items-center gap-1.5 mb-3">
                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold {{ $targetRoleModel?->badge_class ?? 'bg-gray-100 text-gray-700' }}">
                        {{ $targetRoleModel?->label ?? strtoupper($task->target_role) }}
                    </span>
    ...
    <x-responsive-modal id="modal-edit">
        ...
        <form id="form-edit" action="" method="POST" class="px-3 sm:px-6 py-5 space-y-4 pt-1 overflow-y-auto flex-1">
            @csrf
            @method('PATCH')
            <div>
                <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Judul Tugas</label>
