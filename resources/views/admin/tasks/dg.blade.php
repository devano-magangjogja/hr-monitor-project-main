...
@section('title', 'Pantau DG (Design Graphics)')
@section('page-title', 'Pantau DG (Design Graphics)')
@section('page-subtitle', 'Pantau seluruh tugas yang masuk ke DG (Design Graphics) hari ini')
