...
@section('title', 'Pantau PM (Project Manager)')
@section('page-title', 'Pantau PM (Project Manager)')
@section('page-subtitle', 'Pantau seluruh tugas yang masuk ke PM (Project Manager) hari ini')
        ...
        @empty
            <tr>
                <td colspan="6" class="px-3 sm:px-6 py-12 text-center text-gray-400 text-sm">
                    Tidak ada tugas dari PM hari ini.
                </td>
            </tr>
        @endforelse
        </tbody>
