...
@section('title', 'Pantau Programmer')
@section('page-title', 'Pantau Programmer')
@section('page-subtitle', 'Pantau seluruh tugas yang masuk ke Programmer hari ini')
        ...
        @empty
            <tr>
                <td colspan="6" class="px-3 sm:px-6 py-12 text-center text-gray-400 text-sm">
                    Tidak ada tugas dari Programmer hari ini.
                </td>
            </tr>
        @endforelse
        </tbody>
