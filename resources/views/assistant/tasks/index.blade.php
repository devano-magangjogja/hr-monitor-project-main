...
@section('content')
            ...
            <table class="w-full text-sm text-left border-collapse min-w-[750px]">
                <thead>
                    <tr
                        ...
                        <th scope="col" class="px-5 py-3.5 w-56 text-left">Judul</th>
                        <th scope="col" class="px-5 py-3.5 w-20 text-left">Kantor</th>
                        <th scope="col" class="px-5 py-3.5 w-40 text-left">Deskripsi</th>
                        <th scope="col" class="px-5 py-3.5 w-24 text-left">Sumber</th>
                        <th scope="col" class="px-5 py-3.5 w-32 text-left">Status</th>
                        <th scope="col" class="px-5 py-3.5 w-16 text-center">Aksi</th>
                    </tr>
                </thead>
                    ...
                    @forelse($tasks as $task)
                            ...
                            'assignees' => [],
                                        ...
                                        <td class="px-5 py-3.5 whitespace-nowrap">
                                            <div class="truncate max-w-[180px] font-medium text-gray-900" title="{{ $task->title }}">
                                                {{ $task->title }}
                                            </div>
                                        </td>

                                        {{-- Kantor: Kunci dengan whitespace-nowrap agar 1 garis lurus --}}
                                        ...
                                        <td class="px-5 py-3.5">
                                            <div class="truncate max-w-[300px] text-gray-500"
    ...
    <x-responsive-modal id="modal-create">
        ...
        <form action="{{ route('assistant.tasks.store') }}" method="POST" class="px-3 sm:px-6 py-5 space-y-4">
            @csrf
            <div>
                <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Judul Tugas</label>
                <input type="text" name="title" value="{{ old('title') }}" required maxlength="200" class="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-300 rounded-lg text-xs sm:text-sm
    ...
    <x-responsive-modal id="modal-edit">
        ...
        <form id="form-edit" action="" method="POST" class="px-3 sm:px-6 py-5 space-y-4">
            @csrf
            @method('PATCH')
            <div>
                <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Judul Tugas</label>
                <input type="text" id="edit-title" name="title" required maxlength="200" class="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-300 rounded-lg text-xs sm:text-sm
                                                      focus:outline-none focus:ring-2 focus:ring-primary-500">
            </div>
            <div>
                <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
    ...
    <x-responsive-modal id="modal-complete">
        <div class="flex items-center justify-between px-3 sm:px-6 py-4 border-b border-gray-200">
            <div>
        ...
        <form id="form-complete" action="" method="POST" class="px-3 sm:px-6 py-5 space-y-4">
            @csrf
            @method('PATCH')
            <div>
                <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
            ...
            <div class="flex justify-end gap-2 sm:gap-3 pt-2">
                ...
                <x-responsive-button variant="success" size="sm" type="submit">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
