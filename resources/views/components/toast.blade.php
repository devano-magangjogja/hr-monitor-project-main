...
<div id="toast-success-overlay"
     class="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 backdrop-blur-sm
            opacity-0 transition-opacity duration-300">

    <div id="toast-success-card"
         class="relative bg-white rounded-3xl shadow-2xl w-full max-w-sm mx-4 overflow-hidden
                scale-90 opacity-0 transition-all duration-300 ease-out">

        {{-- Dekorasi gelombang hijau di atas --}}
        <div class="relative h-44 bg-gradient-to-br from-green-400 to-emerald-500 flex items-center justify-center overflow-hidden">
            ...
            <div class="absolute top-10 left-1/2 -translate-x-1/2 w-32 h-5 bg-white/10 rounded-full blur-md rotate-3"></div>
            ...
            {{-- Tombol tutup --}}
            <button onclick="dismissSuccessToast()"
                    class="absolute top-3 right-3 w-7 h-7 rounded-full bg-white/20 hover:bg-white/30
...
{{-- ── SUCCESS TOAST KECIL (Pojok Kanan Bawah) ────────── --}}
<div id="toast-success-small"
     role="alert"
     class="fixed bottom-6 right-6 z-[9999] flex items-start gap-3 px-5 py-4 rounded-2xl shadow-xl
            bg-white border border-green-200 max-w-sm w-full
    ...
    <div class="absolute bottom-0 left-0 h-1 rounded-b-2xl bg-green-400"
         id="success-small-progress"
         style="width: 100%; transition: width 4s linear;"></div>
