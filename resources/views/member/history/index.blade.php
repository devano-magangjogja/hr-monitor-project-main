...
@section('content')
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 mb-6">
        <form method="GET" action="{{ route('member.tasks.history') }}" class="flex flex-wrap items-center gap-3">
            ...
            <div class="flex flex-col gap-1">
                ...
                <input type="date" name="date" value="{{ $date ?? '' }}" class="px-4 py-2 border border-gray-300 rounded-lg text-sm
                                      focus:outline-none focus:ring-2 focus:ring-primary-500">
            </div>

            <button type="submit" class="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white
                                   text-sm font-medium rounded-lg transition mt-auto">
            ...
            @if($date || $search)
                <a href="{{ route('member.tasks.history') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800
