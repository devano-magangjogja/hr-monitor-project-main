...
@section('page-subtitle', 'Tugas khusus yang diberikan langsung oleh Admin')
...
@section('content')
            ...
            <table class="w-full text-sm text-left border-collapse min-w-[700px]">
                <thead>
                    <tr class="bg-gray-50/80 border-b border-gray-200 text-xs font-semibold uppercase tracking-wider text-gray-500">
                        ...
                        <th scope="col" class="px-5 py-3.5 w-[14%] min-w-[90px] text-left">Status</th>
                        <th scope="col" class="px-5 py-3.5 w-[8%] min-w-[60px] text-center">Aksi</th>
                    </tr>
                </thead>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-14 text-center">
                                <div class="flex flex-col items-center gap-2">
                                    ...
                                    <p class="text-sm font-medium text-gray-500">Tidak ada tugas dari Admin hari ini.</p>
                                    <p class="text-xs text-gray-400">Tugas akan muncul jika Admin memberikan tugas kepadamu.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
    ...
    <script>
        function openCompleteModal(id, title) {
            ...
            document.getElementById('form-complete').action = `/member/tasks/assigned/${id}/complete`;
