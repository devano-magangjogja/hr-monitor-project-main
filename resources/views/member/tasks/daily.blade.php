...
@section('page-subtitle', 'Tugas rutin yang di-generate otomatis setiap hari')
...
@section('content')
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-14 text-center">
                                <div class="flex flex-col items-center gap-2">
                                    ...
                                    <p class="text-sm font-medium text-gray-500">Tidak ada tugas harian hari ini.</p>
                                    <p class="text-xs text-gray-400">Tugas harian akan muncul otomatis setiap jam 08:00 WIB.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
    ...
    <script>
        function openCompleteModal(id, title) {
            ...
            document.getElementById('form-complete').action = `/member/tasks/daily/${id}/complete`;
