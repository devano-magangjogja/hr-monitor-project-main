...
@section('content')
    ...
    <div id="modal-add-pemagang" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md z-10 overflow-hidden">
            ...
            <form method="POST" action="{{ route($routePrefix . '.pemagang.store') }}" class="p-6 space-y-4">
                ...
                {{-- Nama Lengkap --}}
                <div>
                    <label class="block text-xs font-semibold text-gray-700 mb-1">Nama Lengkap <span
                ...
                {{-- No WhatsApp / HP --}}
                <div>
                    <label class="block text-xs font-semibold text-gray-700 mb-1">Nomor WhatsApp / HP <span
                            class="text-red-500">*</span></label>
                ...
                {{-- Asal Kampus / Sekolah --}}
                <div>
                    <label class="block text-xs font-semibold text-gray-700 mb-1">Asal Kampus / Sekolah <span
                            class="text-red-500">*</span></label>
                ...
                {{-- Divisi --}}
                <div>
                    <label class="block text-xs font-semibold text-gray-700 mb-1">Divisi Magang <span
                            class="text-red-500">*</span></label>
    ...
    <div id="modal-edit-pemagang" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md z-10 overflow-hidden">
            ...
            <form id="form-edit-pemagang" method="POST" action="" class="p-6 pt-1 space-y-4">
                @csrf
                @method('PATCH')
