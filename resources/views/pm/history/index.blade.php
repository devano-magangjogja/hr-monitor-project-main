...
@section('content')
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 mb-6">
        <form method="GET" action="{{ route('pm.tasks.history') }}" class="flex flex-wrap items-center gap-3">
            ...
            @if($date || $search)
                <a href="{{ route('pm.tasks.history') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800
