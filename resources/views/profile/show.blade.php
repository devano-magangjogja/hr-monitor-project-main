    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        <div class="flex items-center gap-5">
            ...
            <div class="flex-1 min-w-0">
                ...
                <span
                    class="inline-flex items-center mt-2 px-2.5 py-1 rounded-full text-xs font-medium
                                                             border {{ $roleColor }}">
                    {{ $roleLabel }}
                </span>
            </div>

            {{-- Bagian Kanan: Bergabung Sejak + Tombol Log Out --}}
            <div class="flex flex-col items-end justify-center gap-2.5 flex-shrink-0">
                ...
                <form action="{{ route('logout') }}" method="POST"
                    ...
                    @csrf
                    <button type="submit"
                        class="inline-flex items-center gap-2 px-3.5 py-1.5 bg-red-50 hover:bg-red-600 text-red-600 hover:text-white border border-red-200 hover:border-red-600 text-xs font-semibold rounded-lg transition duration-150 shadow-2xs">
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data"
                ...
                <div x-data="{
                    ...
                    <div class="flex items-start gap-3">
                        {{-- Thumbnail --}}
                        <div
                            class="w-14 h-14 rounded-xl overflow-hidden border border-gray-200
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-2 flex-wrap">
                                <label
                                    class="cursor-pointer inline-flex items-center gap-1.5 px-3 py-1.5
