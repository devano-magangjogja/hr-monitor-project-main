...
@section('page-subtitle', 'Seluruh tugas mandiri, rutin, dan penugasan hari ini')
@section('sidebar')
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($tasks as $task)
                        ...
                        <tr class="hover:bg-gray-50 transition" data-task="{{ json_encode([
                            ...
                            'source' => $task->type === 'self' ? 'Mandiri' : ($task->type === 'default' ? 'Sistem' : ($task->creator?->name ?? 'Admin')),
                            'status' => $status,
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-400 text-sm">Tidak ada tugas hari ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
<script>
    function openCompleteModal(id, title) {
        ...
        document.getElementById('form-complete').action = `/sosmed/tasks/all/${id}/complete`;
