@extends('layouts.app')
@section('title', 'Tugas dari Admin / PM')
@section('page-title', 'Tugas dari Admin / PM')
@section('page-subtitle', 'Tugas yang didelegasikan khusus kepada kamu hari ini')
@section('sidebar')
            ...
            <table class="w-full text-sm min-w-[580px]">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-200">
                        ...
                        <th class="text-left px-6 py-3.5 font-semibold text-gray-600 w-32">Pemberi</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($tasks as $task)
                        ...
                        <tr class="hover:bg-gray-50 transition" data-task="{{ json_encode([
                            ...
                            'source' => $task->creator?->name ?? 'Admin',
                            'status' => $status,
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-400 text-sm">Tidak ada tugas yang ditugaskan hari ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
...
<script>
    function openCompleteModal(id, title) {
        ...
        document.getElementById('form-complete').action = `/sosmed/tasks/assigned/${id}/complete`;
