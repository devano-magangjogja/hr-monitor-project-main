...
@section('content')
    @include('components.notification-popup')
        ...
        {{-- ── Stat Cards ──────────────────────────────────────── --}}
        <x-responsive-grid :cols="'grid-cols-2 lg:grid-cols-4'" :gap="'gap-3 sm:gap-4 md:gap-5'">
            ...
            <x-responsive-card :padding="'p-3.5 sm:p-4 md:p-5'" class="h-full flex flex-col justify-between hover:shadow-md transition-shadow duration-200">
                ...
                <div>
                    ...
                    <p class="text-[11px] sm:text-xs text-gray-400 mt-1 truncate">dalam pengerjaan</p>
                </div>
            </x-responsive-card>
            ...
            <x-responsive-card :padding="'p-3.5 sm:p-4 md:p-5'" class="h-full flex flex-col justify-between hover:shadow-md transition-shadow duration-200">
                ...
                <div>
                    ...
                    <p class="text-[11px] sm:text-xs text-gray-400 mt-1 truncate">lewat batas waktu</p>
                </div>
            </x-responsive-card>
