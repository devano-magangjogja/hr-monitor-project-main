...
@section('page-subtitle', 'Buat dan kirimkan notifikasi ke HR Assistant')
...
<div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
    ...
    <div class="lg:col-span-2">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <form action="{{ route('staff.notifications.store') }}" method="POST" class="space-y-4"
                  x-data="{
                      recipients: 'all',
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required maxlength="100"
                           placeholder="Contoh: Pengumuman Rapat Tim"
                ...
                <div>
                    ...
                    <select name="recipients" x-model="recipients"
                            class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm
                                   focus:outline-none focus:ring-2 focus:ring-primary-500">
                        <option value="all">Semua HR Assistant</option>
                        <option value="specific">Pilih HR Assistant Tertentu</option>
                    </select>
                </div>
