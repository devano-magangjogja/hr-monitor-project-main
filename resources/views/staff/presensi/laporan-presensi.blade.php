...
<div class="print:hidden bg-white rounded-xl border border-gray-200 p-4 mb-6 shadow-sm">
    <form method="GET" action="{{ route('staff.presensi.laporan') }}" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
        {{-- Search input --}}
        <div class="relative">
            ...
            <input type="text" name="search" value="{{ request('search') }}"
                   placeholder="Cari nama pemagang / NIM..."
                ...
                @forelse($rekapPemagang as $item)
                    ...
                    <tr class="hover:bg-gray-50/80 transition">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <p class="text-xs text-gray-400 mt-0.5">NIM: {{ $p->nim }} &bull; {{ $p->kampus }}</p>
                        </td>
                ...
                @forelse($logs as $log)
                    ...
                    <tr class="hover:bg-gray-50/80 transition">
                        <td class="px-6 py-3.5">
                            ...
                            <p class="text-[11px] text-gray-400">{{ $pemagang ? $pemagang->nim : '-' }}</p>
                        </td>
                        <td class="px-6 py-3.5">
