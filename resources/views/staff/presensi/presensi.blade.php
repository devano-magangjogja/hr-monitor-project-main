    ...
    <div
        ...
        <div class="flex items-center gap-2 self-start sm:self-auto">
            <button onclick="openCreateModal()"
                class="flex items-center gap-2 px-4 py-2.5 bg-primary-600 hover:bg-primary-700 text-white text-xs sm:text-sm font-semibold rounded-xl transition shadow-sm hover:shadow">
